		...
		<>
			...
			<Layout headerStyle={1} footerStyle={1}>
				<div>
							...
							<div className="row align-items-end">
								<div className="col-lg-7 wow fadeInUp"> <span className="btn btn-brand-secondary"> <img className="mr-10" src="/assets/imgs/page/homepage9/real.svg" alt="Travile" />Resort Real Estate</span>
									<h1 className="neutral-1000 mt-15 mb-15">
										Welcome<span>to Lenz Trav </span>Travel  <span>booking system</span></h1>
					...
					<section className="section-box box-why-book-Lenz Trav-5 background-5">
						<div className="container">
							<div className="row align-items-center">
								<div className="col-lg-6 mb-30"><span className="btn btn-brand-secondary background-0 wow fadeInUp"> <img className="mr-10" src="/assets/imgs/page/homepage4/earth.svg" alt="Travile" />Why book at Lenz Trav ?</span>
						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-lg-6 mb-30 wow fadeInUp">
									<div className="box-author-testimonials button-brand-2 wow fadeInUp"> <img src="/assets/imgs/page/homepage1/testimonial.png" alt="Lenz Trav" /><img src="/assets/imgs/page/homepage1/testimonial2.png" alt="Lenz Trav" /><img src="/assets/imgs/page/homepage1/testimonial3.png" alt="Lenz Trav" />Our Team</div>
								...
								<div className="col-md-6 position-relative text-start text-lg-end mb-30 wow fadeInUp">
									<div className="box-need-help text-start d-inline-block">
										<p className="need-help neutral-1000 text-lg-bold mb-5">Need help? Call us</p><br /><Link className="heading-6 neutral-1000 phone-support" href="/tel:+1 (778) 809 - 5074">+1 (778) 809 - 5074</Link>
									</div>
								</div>
							</div>
								...
								<div className="row">
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team6.png" alt="Lenz Trav" /></div>
											<div className="card-info">
												<h6 className="neutral-1000">Cody Fisher</h6>
												<p className="text-sm-medium neutral-500">Founder and Principal Broker</p>
												<p className="text-xs-medium neutral-1000">With over 15 years of real estate experience, John leads the Lenz Trav team with passion and expertise. His commitment to client satisfaction and market knowledge sets the standard for our exceptional service.</p>
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team.png" alt="Lenz Trav" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team2.png" alt="Lenz Trav" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team3.png" alt="Lenz Trav" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team4.png" alt="Lenz Trav" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team5.png" alt="Lenz Trav" /></div>
											<div className="card-info">
