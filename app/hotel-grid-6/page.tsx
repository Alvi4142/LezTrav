								...
								<div className="row align-items-center">
									<div className="col-lg-6">
										<div className="box-item-download wow fadeInUp"> <span className="btn btn-brand-secondary">Install APP   Get  discount code</span>
											...
											<div className="box-button-download"> <Link href="#"><img src="/assets/imgs/page/homepage6/googleplay.png" alt="Lenz Trav" /></Link><Link href="#"><img src="/assets/imgs/page/homepage6/appstore.png" alt="Lenz Trav" /></Link></div>
										</div>
									</div>
									<div className="col-lg-6"><img className="wow fadeInUp" src="/assets/imgs/page/homepage6/img-download-app.png" alt="Lenz Trav" /></div>
								</div>
							</div>
						</div>
					</section>
