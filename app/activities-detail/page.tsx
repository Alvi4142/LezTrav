							...
							<div className="container-banner-activities">
								<div className="box-banner-activities">
									<Slider {...settingsMain} ref={slider1} className="banner-activities-detail">
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Lenz Trav" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Lenz Trav" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Lenz Trav" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Lenz Trav" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/activities/banner.png" alt="Lenz Trav" /></div>
								...
								<div className="slider-thumnail-activities">
									<Slider {...settingsThumbs} ref={slider2} className="slider-nav-thumbnails-activities-detail">
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb.png" alt="Lenz Trav" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb2.png" alt="Lenz Trav" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb3.png" alt="Lenz Trav" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb.png" alt="Lenz Trav" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb.png" alt="Lenz Trav" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb2.png" alt="Lenz Trav" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/homepage2/thumb3.png" alt="Lenz Trav" /></div>
						...
						<div className="container">
							...
							<div className="row mt-30">
								...
								<div className="col-lg-4">
											...
											<ul>
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/tour/post.png" alt="Lenz Trav" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/tour/post2.png" alt="Lenz Trav" /></Link></div>
														<div className="card-info"> <Link className="text-xs-bold" href="#">Singapore Skylines: Urban Exploration</Link><span className="price text-sm-bold neutral-1000">$48.25</span><span className="price-through text-sm-bold neutral-500">$60.75</span></div>
													</div>
												</li>
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/tour/post3.png" alt="Lenz Trav" /></Link></div>
														<div className="card-info"> <Link className="text-xs-bold" href="#">Singapore Skylines: Urban Exploration</Link><span className="price text-sm-bold neutral-1000">$48.25</span><span className="price-through text-sm-bold neutral-500">$60.75</span></div>
													</div>
												</li>
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/tour/post4.png" alt="Lenz Trav" /></Link></div>
														<div className="card-info"> <Link className="text-xs-bold" href="#">Singapore Skylines: Urban Exploration</Link><span className="price text-sm-bold neutral-1000">$48.25</span><span className="price-through text-sm-bold neutral-500">$60.75</span></div>
													</div>
												</li>
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/tour/post5.png" alt="Lenz Trav" /></Link></div>
														<div className="card-info"> <Link className="text-xs-bold" href="#">Singapore Skylines: Urban Exploration</Link><span className="price text-sm-bold neutral-1000">$48.25</span><span className="price-through text-sm-bold neutral-500">$60.75</span></div>
													</div>
												</li>
											</ul>
									...
									<div className="sidebar-banner"> <Link href="#"><img src="/assets/imgs/page/tour-detail/banner-ads.png" alt="Lenz Trav" /></Link></div>
									<div className="sidebar-banner"> <Link href="#"><img src="/assets/imgs/page/tour-detail/banner-ads2.png" alt="Lenz Trav" /></Link></div>
								</div>
							</div>
						</div>
					</section>
