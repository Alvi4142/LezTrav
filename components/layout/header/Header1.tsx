				...
				<div className="container-fluid background-body">
					<div className="main-header">
						<div className="header-left">
							<div className="header-logo"><Link className="d-flex" href="/"><img className="light-mode" alt="Lenz Trav" src="/assets/imgs/template/logo.svg" /><img className="dark-mode" alt="Lenz Trav" src="/assets/imgs/template/logo-w.svg" /></Link></div>
													...
													<div className="row align-items-center">
														<div className="col-lg-10">
															<div className="row align-items-center">
																...
																<div className="col-lg-4">
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/"> <img src="/assets/imgs/template/icons/activity.svg" alt="Lenz Trav" /></Link>
																	...
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/index-2"> <img src="/assets/imgs/template/icons/map.svg" alt="Lenz Trav" /></Link>
																	...
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/index-3"> <img src="/assets/imgs/template/icons/deck-chair.svg" alt="Lenz Trav" /></Link>
														...
														<div className="col-lg-2"><img src="/assets/imgs/template/world.png" alt="Lenz Trav" /></div>
													</div>
												</div>
											</div>
										</li>
						...
						<div className="header-right">
							...
							<div className="burger-icon-2 burger-icon-white" onClick={handleSidebar}>
								<img src="/assets/imgs/template/icons/menu.svg" alt="Lenz Trav" />
							</div>
