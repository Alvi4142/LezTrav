		...
		<>
			<div className={`mobile-header-active mobile-header-wrapper-style perfect-scrollbar button-bg-2 ${isMobileMenu ? "sidebar-visible" : ""}`}>
				<PerfectScrollbar className="mobile-header-wrapper-inner">
					<div className="mobile-header-logo"> <Link className="d-flex" href="/"><img className="light-mode" alt="Lenz Trav" src="/assets/imgs/template/logo.svg" /><img className="dark-mode" alt="Lenz Trav" src="/assets/imgs/template/logo-w.svg" /></Link>
