                            ...
                            <div className="box-list-flights">
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/logo1.png" alt="Lenz Trav" />
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/tokyo.png" alt="Lenz Trav" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/sydney.png" alt="Lenz Trav" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/dubai.png" alt="Lenz Trav" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/los.png" alt="Lenz Trav" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/paris.png" alt="Lenz Trav" />
                                            <div className="flight-info">
