        ...
        <>
            ...
            <section className="section-box block-why-choose-us background-body">
                <div className="container">
                    <div className="bg-why shape-1 wow fadeInUp"> <img className="light-mode" src="/assets/imgs/page/homepage9/bg-dot.png" alt="Lenz Trav" /><img className="dark-mode" src="/assets/imgs/page/homepage9/bg-dot-dark.png" alt="Lenz Trav" /></div>
                    <div className="bg-why-2 shape-2 wow fadeInUp"><img className="light-mode" src="/assets/imgs/page/homepage9/bg-dot-2.png" alt="Lenz Trav" /><img className="dark-mode" src="/assets/imgs/page/homepage9/bg-dot-2-dark.png" alt="Lenz Trav" /></div>
                        ...
                        <div className="box-why-home9-inner-inner">
                            ...
                            <div className="box-list-why wow fadeInUp">
                                <div className="card-why-travel card-love-us wow fadeInUp">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/support.svg" alt="Lenz Trav" /></div>
                                ...
                                <div className="card-why-travel card-love-us card-margin-left wow fadeInUp">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/repu.svg" alt="Lenz Trav" />
                                    </div>
                                ...
                                <div className="card-why-travel card-love-us wow fadeInUp">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/security.svg" alt="Lenz Trav" /></div>
