                            ...
                            <div className="col-lg-6">
                                <div className="box-item-download wow fadeInUp"> <span className="btn btn-brand-secondary">Install
                                    ...
                                    <h5 className="mt-15 mb-30">Up to 55% Discount<br className="d-none d-lg-block" />and lots of
                                        special gifts</h5>
                                    <div className="box-button-download"> <Link href="#"><img src="/assets/imgs/page/homepage6/googleplay.png" alt="Lenz Trav" /></Link><Link href="#"><img src="/assets/imgs/page/homepage6/appstore.png" alt="Lenz Trav" /></Link>
                                    </div>
                                </div>
                            </div>
