			...
			<Swiper {...swiperGroup8}>
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/eiffel-tower.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/MachuPicchu.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/GreatWall.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/StatueofLiberty.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/TajMahal.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/OperaHouse.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/Colosseum.png" alt="Lenz Trav" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/GrandCanyon.png" alt="Lenz Trav" /></div>
